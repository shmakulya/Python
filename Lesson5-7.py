...
# my_seventh_file = open('Seventh_file.txt', 'r')
...
prof_aver = 0
i = 0
with open('Seventh_file.txt', 'r', encoding='utf-8') as my_seventh_file:
    for line in my_seventh_file:
    ...
    if i != 0:
        ...
        print(f'Average profit - отсутсвует. Все работают в убыток')
    pr = {'Average profit': round(prof_aver)}
    profit.update(pr)
    print(f'Profit of each company - {profit}')

with open('Seventh_file.json', 'w', encoding='utf-8') as write_js:
